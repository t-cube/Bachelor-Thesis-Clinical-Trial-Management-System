...
/**
 * The client side protocol, which handles incoming messages and depending on them
 * calls the functions of the controller.
 * 
...
public class ContactsProtocol implements Protocol 
{
	...
	public void interpret(JSONObject msg, AbstractController c)
		...
		CONTACTS_COMMANDS cmd = CONTACTS_COMMANDS.valueOf(msg.
															getString("Command"));
		...
		{
			tempController = cc.getClientController().getController(receiver);
